const apps = [
  ...
  { name: "MENEMENTALE", platform: "iOS / Android", desc: "From not the creator of Undertale — a new story in a dark world.", size: "250 MB", url: "https://loadly.io/menementale" },
...
function renderApps(filter = "") {
  ...
  filtered.forEach(app => {
    ...
    div.innerHTML = `
      ...
      <button class="install-btn" onclick="window.open('${app.url}', '_blank')">Install</button>
    `;
